prompts_cfg = {
    ...
    "extract_bullet":   f"We are analyzing a resume from a candidate."
                        ...
                        f"Do not add any introductory sentence or any context. Just generate a JSON object with the key 'experiance-content' and the value will be the list. Do not add markdown formatting, spaces. The result must be ready to parse with a json parser."
}
