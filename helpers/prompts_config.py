prompts_cfg = {
    ...
    "transliterate": "transliterate the following text into the Latin alphabet: ((title of card)). Don't add introductory sentense or any explanation, just give the transliteration.",
